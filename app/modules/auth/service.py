...
class AuthService:
    ...
    def _is_super_admin(cls, user) -> bool:
        return bool(user.is_super_admin) or cls._get_role_name(user) == "SUPER_ADMIN"
    ...
    def login(self, email: str, password: str):
        ...
        if not user.is_active:
            raise AuthenticationException(
                message="Your account is inactive. Please complete account setup or reset your password.",
    ...
    def forgot_password(self, email: str):
        ...
        try:
            ...
            raise AppException(
                message="Unable to send the OTP email right now.",
    ...
    def reset_password(self, email: str, otp: str, new_password: str):
        ...
        return {
            "message": "Account setup successful" if was_inactive else "Password reset successful",
